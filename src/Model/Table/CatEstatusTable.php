 ...
 * @method \App\Model\Entity\CatEstatus|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\CatEstatus saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
